...
var __quasar_inject_import_meta_url__ = "file:///D:/git/myhab/client/web-vue3/quasar.config.js";
  ...
  return {
    ...
    electron: {
      ...
      packager: {
        ...
        // Use local electron installation to avoid network downloads
        electronVersion: __require("electron/package.json").version,
        download: {
          cache: process.env.ELECTRON_CACHE || __require("path").join(__require("os").homedir(), ".electron")
        }
        // OS X / Mac App Store
        // appBundleId: '',
        // appCategoryType: '',
