				...
				<q-card class="bg-transparent no-border no-shadow">
					...
					<div class="row full-width">
						<div class="col-lg-12 col-md-12 cl-sm-12 col-xs-12">
							<div>
								<div class="text-h3 text-center text-white">Under Maintenance</div>
								<div class="text-h6 text-center text-white">Our site is Under Maintenance. We will be back shortly.</div>
							</div>
						</div>
					</div>
				</q-card>
