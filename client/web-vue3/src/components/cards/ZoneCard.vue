<template>
  <q-card class="text-white" style="background: linear-gradient(#546e82, #7c919f); height: 150px" @click="router.push({name: 'zoneById', params: {zoneId: `${zone.id}`}, query: {category: route.query.category}})" v-ripple>
    <q-item>
      <q-item-section>
