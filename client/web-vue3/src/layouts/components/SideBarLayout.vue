<template>
  <q-drawer v-model="isSidebarOpen" :mini="!isSidebarOpen || isSidebarMini" @click.capture="drawerClick" bordered
    persistent class="bg-grey-9 text-white">
      ...
      <q-list>
        ...
        <q-expansion-item v-if="isAdmin" v-model="expanded" icon="mdi-clipboard-edit-outline"
          ...
          <q-list class="q-pl-lg text-weight-light">
            ...
            <q-expansion-item icon="mdi-devices" :label="$t('navigation.devices')"
            ...
            <q-expansion-item icon="mdi-power-socket-au" :label="$t('navigation.peripherals')"
              class="text-weight-bolder text-white">
              <q-list class="q-pl-lg text-weight-light">
