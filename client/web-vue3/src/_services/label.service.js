...
/**
 * Service for downloading printable labels for cables.
 * Backed by REST endpoint GET /api/labels/cable/{id} (binary PNG, not GraphQL — see LabelController).
 */
export const labelService = {
    /**
     * Download a cable label image and trigger a browser download.
     *
